...
socket.on('collecteddatawritedReturn', function (response) {
    if(response == 'errormsg') {
        ...
        console.log('写入')
        $.get("https://www.kenta.cn:8893/type=callfunction?dataname=QueryTableRelation", function(response) {},'json');           
    }
}) 
...
function FormSubmit() {    
    ...
    $.ajax({                
      type:"GET",
      url:"https://www.kenta.cn:8893/type=getdata?dataname=桌子状态",
      async:false,
      dataType:'json',
