...
function FormSubmit(e) {
    ...
    if(allFields.包装类型 == '中箱') {        
        ...
        var mopageinfo = {};
        _.map(selected.mopageinfo,function(m,mkey){            
            if(m == "\\\\"||m == "\\") {
                mopageinfo[mkey] = "——";
            }else {
                mopageinfo[mkey] = m; 
