...
socket.on('postidReturn', function (response) {      
    ...
    $.get("https://www.kenta.cn:8893/type=getdata?dataname=桌子对应关系",function(data,status){                            
...
socket.on('collecteddatawritedReturn', function (response) {
    if(response == 'errormsg') {
        ...
        console.log('写入')
        $.get("https://www.kenta.cn:8893/type=callfunction?dataname=QueryTableName", function(response) {},'json');           
    }
}) 
