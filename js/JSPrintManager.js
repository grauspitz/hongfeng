...
(function (JSPM) {
    var ClientPrintJob = (function () {
        ...
        ClientPrintJob.prototype.sendToClient = function () {
            var _this = this;
            return new Promise(function (ok, err) {console.log(121,ok, err)
                _this._generateDataAsync().
                    then(function (data) {console.log(121,data)
                    JSPM.JSPrintManager.WS.send(data)
                        .then(function (i) { ok(i);console.log(122,data) })
